...
HEDGER_DEFAULTS = {
    ...
    # Peak-era (May W21) values restored after day-by-day forensic.
    # T2_HIT count was 2 in May and 0 for 7 weeks after +2% activation.
    # Tight trail was designed for big peaks; too-early activation
    # locks small wins and prevents runners.
